...
public record UserRow(String userId, String userName, String password, String phone,
        String avatar, String intro, int userRole, LocalDateTime registerTime, int status, String address) {
    public UserRow(String userId, String userName, String password, String phone,
        ...
        this(userId, userName, password, phone, avatar, intro, userRole, registerTime, status, null);
    }
    public UserRow(String userId, String userName, String password, String phone,
